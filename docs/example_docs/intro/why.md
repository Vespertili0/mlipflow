...
The first question to address is: why? Why use a mlipflow repository like this? Why make a Python package at all, as opposed to writing custom scripts or Jupyter Notebooks?
...
This is by no means the only mlipflow of its kind. Some alternatives include:
...
- [python-package-mlipflow](https://github.com/microsoft/python-package-mlipflow)

... and many more.

Feel free to use them if you wish! This mlipflow repository exists because we are all opinionated people, and this mlipflow focuses on things that I value most. But the point is to just use something that works well for you.
